...
* link:https://github.com/features/actions[Github Action] / link:https://docs.gitlab.com/ee/ci/[Gitlab CI/CD] - CI/CD pipelinesworkplace
...
* link:https://microcks.io/[Microcks] - Kubernetes native tool for API mocking and testing {oss}
